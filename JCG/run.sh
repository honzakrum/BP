...
# Paths
JCG_PATH="/mnt/c/projects/BP/code/JCG"
...
sbt "; project jcg_evaluation; runMain Evaluation --input $JCG_PATH/$INPUT_DIR --output $JCG_PATH/$OUTPUT_DIR --adapter $TOOL --algorithm-prefix $ALGORITHM"
